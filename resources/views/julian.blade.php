...
<html lang="{{ config('app.locale') }}">
    ...
    <body>
        <div class="col-xs-12 col-md-4 col-md-offset-4">
            @foreach(range(1, 9) as $ranger)
                <img src="https://s3.amazonaws.com/shitsource/julian/0{{$ranger}}.jpg"><br>
            @endforeach
            @foreach(range(10, 20) as $ranger)
                <img src="https://s3.amazonaws.com/shitsource/julian/{{$ranger}}.jpg"><br>
            @endforeach
        </div>
    </body>
</html>
